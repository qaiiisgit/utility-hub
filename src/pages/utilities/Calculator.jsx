...
const Calculator = () => {
  ...
  const buttons = [
    ...
    { label: '7', action: () => handleNumber('7'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '8', action: () => handleNumber('8'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '9', action: () => handleNumber('9'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '×', action: () => handleOperator('*'), style: 'bg-indigo-600 hover:bg-indigo-500 text-white' },
    { label: '4', action: () => handleNumber('4'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '5', action: () => handleNumber('5'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '6', action: () => handleNumber('6'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '−', action: () => handleOperator('-'), style: 'bg-indigo-600 hover:bg-indigo-500 text-white' },
    { label: '1', action: () => handleNumber('1'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '2', action: () => handleNumber('2'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '3', action: () => handleNumber('3'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '+', action: () => handleOperator('+'), style: 'bg-indigo-600 hover:bg-indigo-500 text-white' },
    { label: 'DEL', action: handleDelete, style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '0', action: () => handleNumber('0'), style: 'bg-gray-800 hover:bg-gray-700 text-white' },
    { label: '.', action: handleDecimal, style: 'bg-gray-800 hover:bg-gray-700 text-white' },
